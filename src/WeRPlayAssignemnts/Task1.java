...
public class Task1 {
	...
	String CusURL = "https://www.ounass.ae/customer";
	...
	
	{
		...
		//Code written below is for Login but i am getiing 403 Error On that
		
	/*	driver.get("https://www.ounass.ae/customer/login");
		driver.manage().window().maximize();
		Thread.sleep(5000);
		driver.findElement(By.id("onesignal-slidedown-cancel-button")).click();
		driver.findElement(By.name("email")).sendKeys(Email);
		driver.findElement(By.name("password")).sendKeys("Asdf1@34");
		driver.findElement(By.xpath("/html/body/div[1]/div/div[1]/div[3]/div/div[2]/div[1]/div/form/button")).click();
		Thread.sleep(5000);*/
...
public void FieldVerification()
	...
	
	{
		...
		//driver.findElement(By.id("firstName")).sendKeys("Bilal"); //USer is registered so these fields are not required
